export default async function handler(req, res) {
  ...
  res.status(200).json(altText ? altText : "Sorry, we can't generate text from this file or image type. It may not be supported. Please try using other image types like 'jpg' or 'png'.");
}