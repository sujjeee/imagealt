...
const Hero = ({ onImageData }) => {
    ...
    return (
        <div className='flex flex-1 w-full flex-col items-center justify-center text-center px-4 sm:mt-20 mt-20 background-gradient py-16 ' >
            <h1 className="mx-auto  max-w-[300px] sm:max-w-3xl text-4xl font-bold  text-gray-300 sm:text-7xl ">
                Generate  {" "}
            ...
            <h2 className="mx-auto mt-12 max-w-[320px] sm:max-w-3xl text-sm sm:text-lg sm:text-gray-400  text-gray-500 ">
